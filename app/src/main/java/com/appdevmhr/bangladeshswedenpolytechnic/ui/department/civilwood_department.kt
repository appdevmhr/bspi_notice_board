...
class civilwood_department : Fragment(), simpleMethod {
    var binding: FragmentCivilwoodDepartmentBinding? = null
    override fun onCreateView(
        ...
        binding!!.OurTeachers.setOnClickListener {
            setIntentForSetPeaple(
                activity, TeacherView::class.java, "cwtTeachers", ""
            )
        }
        ...
        binding!!.br.setOnClickListener {
            ...
            intent.putExtra("collection","civilwood_BoardResult")
            startActivity(intent)
        }
        binding!!.cr.setOnClickListener {
            val intent = Intent(context, BoardResultView::class.java)
            intent.putExtra("collection","civilwood_ClassRoutine")
            startActivity(intent)
        }
        ...
        binding!!.SemesterPlan.setOnClickListener {
            val intent = Intent(context, BoardResultView::class.java)
            intent.putExtra("collection","civilwood_SemesterPlan")
            startActivity(intent)
        }
        ...
        binding!!.Syllabus.setOnClickListener {
            val intent = Intent(context, BoardResultView::class.java)
            intent.putExtra("collection","civilwood_Syllabus")
            startActivity(intent)
        }
        ...
        binding!!.DigitalContent.setOnClickListener {
            val intent = Intent(context, BoardResultView::class.java)
            intent.putExtra("collection","civilwood_DigitalContent")
            startActivity(intent)
        }
        ...
        binding!!.DepartmentNotice.setOnClickListener {
            val intent = Intent(context, BoardResultView::class.java)
            intent.putExtra("collection","civilwood_DepartmentNotice")
            startActivity(intent)
        }
        ...
        binding!!.Stipend.setOnClickListener {
            val intent = Intent(context, BoardResultView::class.java)
            intent.putExtra("collection","civilwood_Stipend")
            startActivity(intent)
        }
        ...
        binding!!.StudentInformation.setOnClickListener {
            setIntentForSetUploadSession(
                context,
                StudentInfo::class.java, "StudentInfo", "", "civilwood"
            )
